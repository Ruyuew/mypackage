...
#' @param method One of `"simple"` or `"pivot"`. `"simple"` searches for the maximal partial clique using a modified version of the original Bron-Kerbosch algorithm, and `"pivot"` uses a modified version of the Bron-Kerbosch algorithm with pivot (Bron & Kerbosch 1973).
#' @return Outputs a list containing \itemize{
...
#' @export
compute_maximal_partial_clique1 <- function(adj_mat, alpha, method = c("simple", "pivot")) {
  ## Check adj_mat
  ...
  ## Find maximum clique size using Bron-Kerbosch
